...
| **สูตร estimate ไม่ได้ calibrate** | ต่ำกว่า TC-12 เกือบ 40% (ดูข้อ 2) · **20/08/2026 วัดซ้ำแล้วห่างกว่านั้น** — คลิป 1 นาที 4K · Face · NPU แสดง `~ 35s` แต่ของจริง **~85 วินาที** ตั้งแต่กด Extract จนรูปครบคิว คือ **ต่ำไปกว่าเท่าตัว** |
